...
CREATE TABLE `areas` (
  ...
  KEY `fk_areas_parent` (`parent_area_id`),
  KEY `fk_areas_jefe` (`jefe_id`),
  CONSTRAINT `fk_areas_sede` FOREIGN KEY (`sede_id`) REFERENCES `sedes` (`id`),
  CONSTRAINT `fk_areas_parent` FOREIGN KEY (`parent_area_id`) REFERENCES `areas` (`id`) ON DELETE SET NULL
...
CREATE TABLE `mantenimientos` (
  ...
  `estado` enum('Pendiente','En Proceso','Completada','Cancelado') DEFAULT 'En Proceso',
